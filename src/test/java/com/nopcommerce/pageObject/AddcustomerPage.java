...
import org.openqa.selenium.support.ui.Select;
	...
	public WebDriver driver; // Created driver
	WebElement listitem;
	
			
	public AddcustomerPage(WebDriver driver) //Created constructor which will take driver as argument from the testcase
	{
	        this.driver=driver;
