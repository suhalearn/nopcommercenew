...
public class ExtentReportManager implements ITestListener
{
	...
	public void onTestSuccess(ITestResult result)
	{
	   ...
	   test=extent.createTest(result.getTestContext().getName()); //This will return the test case ID
	   test.createNode(result.getName());  //This will return the test method name
